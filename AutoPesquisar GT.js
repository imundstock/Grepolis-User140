...
// @name         GPAcademy
// @version      0.1.5
// @description  Planejador de pesquisas por cidade com execução automática sequencial
// @author       Developed by: @Leyarl
...
(async function () {
    ...
    if (usedForMultiAccounting) {
        const predefinedResearches = [
            ...
            "colonize_ship", "democracy", "mathematics", "meteorology", "plow", "pottery", "combat_experience"
        ];
    ...
    function tryAutoResearch(research, townOverride = null) {
        ...
        if (academy < reqsTech.building_dependencies.academy ||
